    ...
    try {
        ...
        for (const artifact of artifacts) {
            try {
                ...
                const key = `TrainingArtifacts/Stage1/${artifact.file}`;
...
async function main() {
    ...
    try {
        // Step 1: Run training script for levels 1-5
        console.log(`🎓 Step 1: Running ${PPO_TYPE.toUpperCase()} PPO training (${STAGE_NAME})...`);
