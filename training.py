...
def main():
    ...
    print(f"   - State Dimension: {state_dim}D (Vision-Based)")
    print(f"   - UAV State: 9D (position, velocity, goal distance)")
    print(f"   - Visual Features: 32D (camera-based obstacle & goal detection)")
    print(f"     * Obstacle detection, Goal recognition, Depth estimation")
    print(f"     * Spatial awareness, Navigation confidence")
    print()
    ...
    print(f"   - Vision Obstacle Penalties: -0.5 to -5.0")
