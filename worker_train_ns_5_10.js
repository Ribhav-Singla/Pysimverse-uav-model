...
async function downloadWeights() {
    try {
        ...
        // Download NS PPO weights from stage 1
...
async function uploadTrainingArtifacts() {
    try {
        ...
        // Define training artifacts to upload for NS PPO
        const artifacts = [
        ...
        for (const artifact of artifacts) {
            try {
                ...
                const key = `TrainingArtifacts/Stage2/${artifact.file}`;
...
async function main() {
    console.log(`🚀 Starting ${PPO_TYPE.toUpperCase()} PPO Training (${STAGE_NAME}) and Weight Upload Process...`);
    ...
    try {
        ...
        // Step 2: Run training script for levels 5-10
        ...
        console.log('📦 Step 3: Uploading trained weights...');
        ...
        console.log(`\n✅ ${PPO_TYPE.toUpperCase()} PPO training (${STAGE_NAME}) and upload process completed successfully!`);
        process.exit(0);
