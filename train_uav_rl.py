...
class UAVTrainer:
    ...
    def __init__(self, config=None):
        ...
        self.config = {
            ...
            'render': False,  # Whether to render episodes
            'render_episodes': [0, 1, 2, 5, 10, 25, 50, 100, 200, 500, 1000, 1500],  # Episodes to render
            'render_frequency': 100  # Render every N episodes after initial list
        }
